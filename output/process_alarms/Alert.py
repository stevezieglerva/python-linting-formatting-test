...
class AlertMessage:
	...
	def __init__(self, alert_name, subject, simple_message, remediation, project_info, context, event_details_json, s3_bucket, log_error_details):
		...
		alert_json = {"alert" : self.formatted_text, "simple_description" : f"alert {subject}"}
